...
public class T1 extends JFrame {
    ...
    public T1() {
        ...
        btnCancel.setBounds(314, 450, 100, 30);
    ...
    private void submitAttendance() {
        ...
        String subject = (classIndex == 0) ? "PROBLEM SOLVING USING C" : "JAVA PROGRAM"; 
        try (Connection conn = DriverManager.getConnection(dbURL, dbUser, dbPassword)) {
            ...
            for (int i = 0; i < 10; i++) {
            	stmt.setString(1, (classIndex == 0) ? "I BSc. CSCY" : "II BSc. CSCY");
