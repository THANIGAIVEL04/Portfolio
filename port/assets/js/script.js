...
// ===========================
document.addEventListener('DOMContentLoaded', () => {
    const protectedPhoto = document.getElementById('protected-profile-photo');

    if (protectedPhoto) {
        // Disable right-click context menu on profile photo
        protectedPhoto.addEventListener('contextmenu', (e) => {
            e.preventDefault();
            return false;
        });

        // Disable drag on profile photo
        protectedPhoto.addEventListener('dragstart', (e) => {
            e.preventDefault();
            return false;
        });

        // Disable selection on profile photo
        protectedPhoto.addEventListener('selectstart', (e) => {
            e.preventDefault();
            return false;
        });

        // Also protect the parent container
        const profileContainer = protectedPhoto.closest('.profile-image');
        if (profileContainer) {
            ...
            profileContainer.addEventListener('dragstart', (e) => {
                e.preventDefault();
                return false;
            });
        }
